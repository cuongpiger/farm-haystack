...
from farm_haystack.modeling.model.multimodal.base import HaystackModel
from farm_haystack.modeling.model.multimodal.sentence_transformers import HaystackSentenceTransformerModel
