...
from farm_haystack.nodes.retriever._embedding_encoder import (
    _EMBEDDING_ENCODERS,
...
with LazyImport(message="Run 'pip install farm-haystack[inference]'") as torch_and_transformers_import:
    ...
    from farm_haystack.modeling.model.triadaptive_model import TriAdaptiveModel
    from farm_haystack.modeling.model.prediction_head import TextSimilarityHead
    from farm_haystack.modeling.data_handler.processor import TextSimilarityProcessor, TableTextSimilarityProcessor
    from farm_haystack.modeling.data_handler.data_silo import DataSilo
    ...
    from farm_haystack.modeling.training.base import Trainer
    from farm_haystack.modeling.utils import initialize_device_settings  # pylint: disable=ungrouped-imports
