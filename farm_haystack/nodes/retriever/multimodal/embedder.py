...
from farm_haystack.errors import NodeError, ModelingError
...
with LazyImport(message="Run 'pip install farm-haystack[inference]'") as torch_and_transformers_import:
    import torch
    from farm_haystack.utils.torch_utils import get_devices  # pylint: disable=ungrouped-imports
    from farm_haystack.modeling.model.multimodal import get_model  # pylint: disable=ungrouped-imports
    from farm_haystack.modeling.model.multimodal.base import HaystackModel  # pylint: disable=ungrouped-imports
