...
from farm_haystack.errors import HaystackError
from farm_haystack.schema import Document, Answer, Span
from farm_haystack.document_stores.base import BaseDocumentStore
from farm_haystack.nodes.reader.base import BaseReader
from farm_haystack.utils import get_batches_from_generator
from farm_haystack.utils.early_stopping import EarlyStopping
from farm_haystack.telemetry import send_event
...
with LazyImport(message="Run 'pip install farm-haystack[inference]'") as torch_and_transformers_import:
    import torch
    from farm_haystack.modeling.data_handler.data_silo import DataSilo, DistillationDataSilo
    from farm_haystack.modeling.data_handler.processor import SquadProcessor, Processor
    ...
    from farm_haystack.modeling.model.optimization import initialize_optimizer
    from farm_haystack.modeling.model.predictions import QAPred, QACandidate
    from farm_haystack.modeling.model.adaptive_model import AdaptiveModel
    from farm_haystack.modeling.training import Trainer, DistillationTrainer, TinyBERTDistillationTrainer
    from farm_haystack.modeling.evaluation import Evaluator
