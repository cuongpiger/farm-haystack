...
from farm_haystack.nodes.prompt.invocation_layer import PromptModelInvocationLayer, TokenStreamingHandler
from farm_haystack.nodes.prompt.invocation_layer.handlers import DefaultTokenStreamingHandler
from farm_haystack.nodes.prompt.invocation_layer.utils import get_task
...
with LazyImport(message="Run 'pip install farm-haystack[inference]'") as torch_and_transformers_import:
    ...
    from farm_haystack.nodes.prompt.invocation_layer.handlers import HFTokenStreamingHandler
