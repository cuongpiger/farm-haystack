...
from farm_haystack.pipelines.config import (
...
from farm_haystack.pipelines.utils import generate_code, print_eval_report
from farm_haystack.utils.deepsetcloud import DeepsetCloud
from farm_haystack.schema import Answer, EvaluationResult, MultiLabel, Document, Span
from farm_haystack.errors import HaystackError, PipelineError, PipelineConfigError, DocumentStoreError
from farm_haystack.nodes import Docs2Answers, BaseReader, BaseSummarizer, BaseTranslator, QuestionGenerator
from farm_haystack.nodes.base import BaseComponent, RootNode
from farm_haystack.nodes.retriever.base import BaseRetriever
from farm_haystack.document_stores.base import BaseDocumentStore
from farm_haystack.utils.experiment_tracking import MLflowTrackingHead, Tracker as tracker
from farm_haystack.telemetry import send_event, send_pipeline_event
...
with LazyImport() as modeling_import:
    from farm_haystack.modeling.evaluation.metrics import semantic_answer_similarity
    from farm_haystack.modeling.evaluation.squad import compute_f1 as calculate_f1_str
    from farm_haystack.modeling.evaluation.squad import compute_exact as calculate_em_str
    from farm_haystack.utils.context_matching import calculate_context_similarity
