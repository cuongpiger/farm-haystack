...
def convert_files_to_docs(
    ...
    from farm_haystack.nodes.file_converter import BaseConverter, DocxToTextConverter, PDFToTextConverter, TextConverter
...
def tika_convert_files_to_docs(
    ...
    """
    try:
        from farm_haystack.nodes.file_converter import TikaConverter
